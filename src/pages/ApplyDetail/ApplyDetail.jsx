        ...
        <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className="top" style={{ display: 'flex', gap: '20px' }}>
                ...
                >
                    ...
                    <h4 className="mt-4">Tên: Nguyễn Văn A</h4>
                    <p>
                        <span>Năm sinh: 01/01/1990</span>
                    </p>
                </div>
            ...
            <div className="describe" style={{ border: '1px solid #ccc', padding: '20px', borderRadius: '8px' }}>
                <h3>Mô tả</h3>
                <p>Xin chào, tôi là một freelancer chuyên về lập trình web. Tôi có kinh nghiệm làm việc với nhiều dự án lớn và luôn đảm bảo chất lượng.</p>
            </div>
        </div>
